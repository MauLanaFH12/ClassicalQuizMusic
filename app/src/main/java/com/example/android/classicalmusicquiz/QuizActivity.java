...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    /**
     * initializes the media to be enabled with media buttons, transport controls, cllbacks
    ...
    /**
     * Shows Media Style Notification, with actions that depend on the current
    ...
    /**
     * Media Sessioon Callback, where all external clients control the player
     */
